...
public class GeneratorConfig {
    ...
    private static final String SEPARATE_MODEL = "separate.model";
    ...
    public static boolean getSeparateModel() {
        return CONFIGS.get(SEPARATE_MODEL).endsWith(Constant.YES);
    }
